...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>js/calendar/bootstrap_calendar.css" type="text/css" />
...
<body>
  ...
  <script src="<?= base_url() ?>js/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="<?= base_url() ?>js/charts/easypiechart/jquery.easy-pie-chart.js"></script>
  <script src="<?= base_url() ?>js/charts/sparkline/jquery.sparkline.min.js"></script>
  <script src="<?= base_url() ?>js/charts/flot/jquery.flot.min.js"></script>
  <script src="<?= base_url() ?>js/charts/flot/jquery.flot.tooltip.min.js"></script>
  <script src="<?= base_url() ?>js/charts/flot/jquery.flot.resize.js"></script>
  <script src="<?= base_url() ?>js/charts/flot/jquery.flot.grow.js"></script>
  <script src="<?= base_url() ?>js/charts/flot/demo.js"></script>

  <script src="<?= base_url() ?>js/calendar/bootstrap_calendar.js"></script>
  <script src="<?= base_url() ?>js/calendar/demo.js"></script>

  <script src="<?= base_url() ?>js/sortable/jquery.sortable.js"></script>
