              ...
              <div class="m-b-md">
               ...
               <section class="panel panel-default">
                ...
                <div class="row wrapper">
                  <div class="col-sm-8">
                    <div>
                      <a href="<?= base_url() ?>insertSP"><i class="fa fa-plus"></i> <b>Thêm sản phẩm</b></a>
                    </div>
                  </div>
                  <div class="col-sm-4">
                  ...
                  <table class="table table-striped b-t b-light">
                    <thead>
                      <tr>
                        ...
                        <th class="th-sortable" data-toggle="class">Sản phẩm
                          <span class="th-sort">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $data['USER_ID'] ?></td>
                        <td><?= $data['CAT_ID']?></td>
                        <td><?= $data['PRO_PRICE'] ?> đồng</td>
                        <td><?= $data['PRO_DESCRIPTION'] ?></td>
                        <td><?= $data['PRO_QUATITY'] ?></td>
                        ...
                        <td>
                          <a href="<?= base_url() ?>sanpham/editSP/<?= $data['PRO_ID'] ?>"<i class="fa fa-pencil"> sửa</i></a>
                          <a href="<?= base_url() ?>sanpham/deleteSP/<?= $data['PRO_ID'] ?>"<i class="fa fa-times"> xóa</i></a>
                        </td>
                        <?php endforeach ?>
                    </tbody>
                  </table>
                ...
                <footer class="panel-footer">
                  <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                      <a href="<?= base_url() ?>sanpham_check"><i class="fa fa-check"></i> <b>Duyệt sản phẩm</b></a>
                    </div>
