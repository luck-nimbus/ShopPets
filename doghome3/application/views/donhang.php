                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $data['BILLDM_ID'] ?></td>
                        <td><?= $data['PRO_NAME'] ?></td>
                        <td><?= $data['DB_SL']?></td>
                        <td><?= $data['PRO_PRICE'] ?> đồng</td>
                        <td>
                          <a href="#" class="non-active" data-toggle="class"><i class="fa fa-times text-danger text"></i><i class="fa fa-check text-success text-active"></i></a>
                        </td>
                        <td>
                          <a href="<?= base_url() ?>sanpham_user/chitiet/<?= $data['BILLDM_ID'] ?>"<i class="fa fa-eye"> Xem khách hàng-</i></a>
                          <a href="<?= base_url() ?>sanpham_user/editSP/<?= $data['BILLDM_ID'] ?>"<i class="fa fa-sun-o"> Xử lý</i></a>
                        </td>
                        <?php endforeach ?>
                    </tbody>
                  </table>
