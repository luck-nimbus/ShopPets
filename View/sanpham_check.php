                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= $data['PRO_AVA'] ?></td>
                        <td>
                          <a href="#" class="non-active" data-toggle="class"><i class="fa fa-check text-success text-active"></i><i class="fa fa-times text-danger text"></i></a>
                        </td>
                        <td>
                          <a href="<?= base_url() ?>sanpham_check/editSP/<?= $data['PRO_ID'] ?>"<i class="fa fa-pencil"> sửa</i></a>
                        </td>
                        <?php endforeach ?>
                    </tbody>
                  </table>
